#This is the tutorial around approximately 40 or 45.
import pygame, time, random

pygame.init()

white = (255,255,255) #RGBA
black = (0,0,0)
red = (255,0,0)
green = (0,155,0)
...
img_head = pygame.image.load('snakehead_0.png')
...
##        tail = pygame.transform.rotate(img_tail, 270)

    elif direction == "left":
        head = pygame.transform.rotate(img_head, 90)
##        tail = pygame.transform.rotate(img_tail, 90)
...
##        tail = pygame.transform.rotate(img_tail, 180)
